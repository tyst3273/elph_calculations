...
def run_calc(U,n,input_file='electron_scf_restart.py'):

    kwargs = {'num_electrons':n,
              'site_density_input_file':f'scf/U_{U:3.2f}_N_{n:3.2f}.hdf5',
              'electron_output_file':f'scf_restart/U_{U:3.2f}_N_{n:3.2f}.hdf5'}
