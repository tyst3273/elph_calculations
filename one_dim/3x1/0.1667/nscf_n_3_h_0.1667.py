...
num_kpts_procs = 6
use_hubbard_U = True
spin_up_site_density = [ 0.8333333333333334, 0.0, 0.8333333333333334]
spin_down_site_density = [ 0.0, 0.8333333333333334, 0.0]
do_electron_scf = False
electron_fixed_fermi_energy = False
calc_electron_fermi_surface = True
electron_delta_width = 0.025
electron_dos_step = 0.01
electron_output_file = 'nscf_n_3_h_0.1667.hdf5'
write_electron_eigenvectors = False
write_site_density = True
electron_eigenvectors_input_file = None
site_density_input_file = 'restart_n_3_h_0.1667.hdf5'
