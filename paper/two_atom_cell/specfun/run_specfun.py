...
def run_calc(U,n,order,input_file='specfun_template.py'):


    kwargs = {'num_electrons':n,
              'site_density_input_file':f'../electrons/nscf/{order}_U_{U:3.2f}_N_{n:3.2f}.hdf5',
              'elph_output_file':f'specfun/{order}_U_{U:3.2f}_N_{n:3.2f}.hdf5'}
