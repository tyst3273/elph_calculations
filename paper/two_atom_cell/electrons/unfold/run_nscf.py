...
def run_calc(n,U,input_file='nscf_template.py'):

    kwargs = {'num_electrons':n,
              'site_density_input_file':f'scf/pm_U_{U:3.2f}_N_{n:3.2f}.hdf5',
              'electron_output_file':f'nscf/pm_U_{U:3.2f}_N_{n:3.2f}.hdf5'}
