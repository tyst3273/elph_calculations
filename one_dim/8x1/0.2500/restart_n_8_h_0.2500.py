...
num_kpts_procs = 4
use_hubbard_U = True
spin_up_site_density = [ 0.75, 0.0, 0.75, 0.0, 0.75, 0.0, 0.75, 0.0]
spin_down_site_density = [ 0.0, 0.75, 0.0, 0.75, 0.0, 0.75, 0.0, 0.75]
...
electron_output_file = 'restart_n_8_h_0.2500.hdf5'
