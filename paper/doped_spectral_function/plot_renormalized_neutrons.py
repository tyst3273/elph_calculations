...
def plot_renormalized_neutrons(specfun_file,mode,show=True):

    fig, ax = plt.subplots(figsize=(6,6),clear=True)

    neutrons_file = 'neutrons_'+mode+'.hdf5'
...
if __name__ == '__main__':
    ...
    plot_renormalized_neutrons(specfun_file='renorm_g2x/pm_U_5.00_N_0.90.hdf5',mode='fb',show=True)
    plot_renormalized_neutrons(specfun_file='renorm_g2x/pm_U_5.00_N_0.90.hdf5',mode='qp',show=True)
    plot_renormalized_neutrons(specfun_file='renorm_g2m/pm_U_5.00_N_0.90.hdf5',mode='hb',show=True)
