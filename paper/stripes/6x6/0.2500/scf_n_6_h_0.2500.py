...
num_kpts_procs = 4
use_hubbard_U = True
spin_up_site_density = [ 0.75, 0.0, 0.75, 0.0, 0.75, 0.0, 0.0, 0.75, 0.0,
     0.75, 0.0, 0.75, 0.75, 0.0, 0.75, 0.0, 0.75, 0.0, 0.0, 0.75, 0.0, 0.75,
     0.0, 0.75, 0.75, 0.0, 0.75, 0.0, 0.75, 0.0, 0.0, 0.75, 0.0, 0.75, 0.0, 0.75,
   ]
spin_down_site_density = [ 0.0, 0.75, 0.0, 0.75, 0.0, 0.75, 0.75, 0.0, 0.75,
     0.0, 0.75, 0.0, 0.0, 0.75, 0.0, 0.75, 0.0, 0.75, 0.75, 0.0, 0.75, 0.0, 0.75,
     0.0, 0.0, 0.75, 0.0, 0.75, 0.0, 0.75, 0.75, 0.0, 0.75, 0.0, 0.75, 0.0]
do_electron_scf = True
max_electron_scf_steps = 100
electron_scf_density_tol = 0.005
electron_scf_energy_tol = 0.0001
calc_electron_fermi_surface = False
electron_dos_step = None
electron_mix_method = 'simple'
electron_mix_alpha = 0.8
electron_output_file = 'scf_n_6_h_0.2500.hdf5'
