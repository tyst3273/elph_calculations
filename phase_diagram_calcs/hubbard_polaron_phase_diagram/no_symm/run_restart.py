...
def run_calc(U,n,order,input_file='restart.py'):

    kwargs = {'num_electrons':n,
              'site_density_input_file':f'scf/electron_{order}_U_{U:3.2f}_N_{n:3.2f}.hdf5',
              'electron_output_file':f'restart/electron_{order}_U_{U:3.2f}_N_{n:3.2f}.hdf5',
              'polaron_output_file':f'restart/polaron_{order}_U_{U:3.2f}_N_{n:3.2f}.hdf5'}
