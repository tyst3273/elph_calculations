...
num_kpts_procs = 4
use_hubbard_U = True
spin_up_site_density = [ 0.9375, 0.0, 0.9375, 0.0, 0.9375, 0.0, 0.0, 0.9375,
     0.0, 0.9375, 0.0, 0.9375, 0.9375, 0.0, 0.9375, 0.0, 0.9375, 0.0, 0.0, 0.9375,
     0.0, 0.9375, 0.0, 0.9375, 0.9375, 0.0, 0.9375, 0.0, 0.9375, 0.0, 0.0, 0.9375,
     0.0, 0.9375, 0.0, 0.9375]
spin_down_site_density = [ 0.0, 0.9375, 0.0, 0.9375, 0.0, 0.9375, 0.9375,
     0.0, 0.9375, 0.0, 0.9375, 0.0, 0.0, 0.9375, 0.0, 0.9375, 0.0, 0.9375, 0.9375,
     0.0, 0.9375, 0.0, 0.9375, 0.0, 0.0, 0.9375, 0.0, 0.9375, 0.0, 0.9375, 0.9375,
     0.0, 0.9375, 0.0, 0.9375, 0.0]
...
electron_output_file = 'scf_n_6_h_0.0625.hdf5'
